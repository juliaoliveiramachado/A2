                       ...
                       st.image(diretorio['LINHA ARGININA']['imagem'])
                           ...
                           if resposta_adicional6 == 'SIM':
                              ...
                              if resposta_adicional7 == 'MUITO':
                                ...
                                resposta_adicional8 = st.checkbox("Ele está desidratado?", ("SIM", "NÃO"))
                                if resposta_adicional8 == 'SIM':
                                   resposta_adicional9 = st.checkbox('Muito?' ("SIM", "NÃO"))
                                   if resposta_adicional9 == 'SIM':
                                      ...
                                      resposta_adicional10 = st.checkbox("Qual seu tipo de cabelo?", ("OLEOSO", "MISTO", "SECO"))
                                      if resposta_adicional10 == 'OLEOSO':
                                         ...
                                         resposta_adicional11 = st.checkbox("Textura do cabelo?", ("LISO", "CACHEADO"))
                                     ...
                                     resposta_adicional11 = st.checkbox("Qual é seu tipo de cabelo?", ("LISO", "CACHEADO"))
                                     if resposta_adicional11 == "LISO":
                                          resposta_adicional12 = st.checkbox("Quer mais liso ou mais longo?", ("LISO", "LONGO"))     
